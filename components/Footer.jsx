...
import { FaYoutube, FaFacebook, FaTwitter, FaInstagram, FaCopyright } from "react-icons/fa"
const Footer = () => {
  return (
      ...
      <div className="container mx-auto z-20 relative">
        <div className="flex flex-col items-center justify-center gap-14">
          ...
          <div className="border-t border-white/10 text-[15px] text-white/70 font-light w-full flex items-center justify-center py-6 ">
            <p className="flex flex-row items-center gap-1"><FaCopyright /> Copyright 2024 - Zenbrew. All rights reseved</p>
          </div>
        </div>
      </div>
    </footer>

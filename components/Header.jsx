      ...
      <div className="container mx-auto">
        <div className="flex justify-between items-center">
          ...
          <button onClick={() => setNavActive(!navActive)}
            ...
            {/* 1 */}
            <span className={`w-full h-[1.5px] bg-current absolute left-0 will-change-transform transition-transform duration-300
              ${navActive ? "top-1/2 rotate-45" : "top-0 translate-y-0"}`}></span>
            {/* 2 */}
            <span className={`w-full h-[1.5px] bg-current absolute left-0 transition-opacity duration-300
